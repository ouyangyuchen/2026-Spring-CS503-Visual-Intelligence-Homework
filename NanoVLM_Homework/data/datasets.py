...
class VQADataset(Dataset):  # Visual Question Answering Dataset
    ...
    def __getitem__(self, idx):
        ...
        answer = text['assistant'] + "<|im_end|>"  # "<|im_end|>" encodes to 2 in the current tokenizer
...
class MMStarDataset(Dataset):  # https://huggingface.co/datasets/Lin-Chen/MMStar
    ...
    def __getitem__(self, idx):
        ...
        answer = item['answer'] + "<|im_end|>" # Add EOS token to the answer to train model to predict it, enabling correct stopping during generation
